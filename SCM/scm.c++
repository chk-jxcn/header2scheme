...
extern "C" {
#include "scm.h"
extern void init_SCM_number_test();
}
#include "patchlvl.h"

/* kbrussel@media.mit.edu 9/95 */
#include "SCMGlobalDispatch.h"
// #include "Ivy.h"
// #include "SchemeCallback.h"
...
#ifdef SIGHUP
static SIGRETTYPE hup_signal(int)
{
	signal(SIGHUP,hup_signal);
	wta(UNDEFINED,(char *)HUP_SIGNAL,"");
}
#endif
static SIGRETTYPE int_signal(int)
{
...
#ifdef FLOATS
static SIGRETTYPE fpe_signal(int)
{
...
#endif
#ifdef SIGBUS
static SIGRETTYPE bus_signal(int)
{
...
static SIGRETTYPE segv_signal(int)
{
...
#endif
#ifdef SIGALRM
static SIGRETTYPE alrm_signal(int)
{
...
#ifdef SIGHUP
static SIGRETTYPE (*oldhup)(int);
#endif
static SIGRETTYPE (*oldint)(int);
#ifdef FLOATS
static SIGRETTYPE (*oldfpe)(int);
#endif
#ifdef SIGBUS
static SIGRETTYPE (*oldbus)(int);
#endif
#ifdef SIGSEGV			/* AMIGA lacks! */
static SIGRETTYPE (*oldsegv)(int);
#endif
#ifdef SIGALRM
static SIGRETTYPE (*oldalrm) (int);
#endif
#ifdef SIGPIPE
...
extern "C" {
#ifdef DLD
  extern void init_dynl();
#endif
#ifdef SUN_DL
  extern void init_dynl();
#endif
void init_scm( int iverbose )
{
  STACKITEM i;
  ...
  init_dynl();
#endif
  // kbrussel@media.mit.edu 10/5/95
...
int run_scm(int argc,char **argv,int iverbose,char *initpath)
{
  SCM i;
  do {
    init_scm( iverbose );
    // following two lines added by kbrussel@media.mit.edu 9/95
    // This is where Ivy used to get initialized.
//    init_Ivy();
//    init_Scheme_Callback();
    progargs = EOL;
    i = argc;
    while (i--)
